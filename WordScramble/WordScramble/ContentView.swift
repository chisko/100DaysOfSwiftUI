...
//  WordScramble
//
//  Created by Francisco Ruiz on 07/12/21.
//
...
struct ContentView: View {
    ...
    func addNewWord() {
        ...
        guard isNotStartWord(word: answer) else {
            wordError(title: "Word is the start of the root word", message: "Don't just use the start word")
            return
        }
        */
    ...
    func isNotStartWord(word: String) -> Bool {
        return word != rootWord.prefix(word.count)
    }
    */
